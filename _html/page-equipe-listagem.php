<?php require_once 'header.php'; ?>
    ...
    <section id="our-team" class="bg-beige">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="our-team-title title-green">
                        <h1>Você está vendo os profissionais do Rio de Janeiro:</h1>
                    </div>
                </div>
            </div>
            <div class="spacer-60"></div>
            <div class="row align-items-center">
                <div class="col-12 col-md-4">
                    <div class="our-team-filter-search">
                        <input type="text" placeholder="BUSCAR">
                        <i class="bi bi-search"></i>
                    </div>
                </div>
                <div class="col-12 col-md-3">
                    <div class="our-team-filter-select">
                        <select>
