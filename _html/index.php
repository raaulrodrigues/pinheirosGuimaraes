<?php require_once 'header.php'; ?>
    ...
    <section id="page-hero">
        <div class="slide fullFirstScreen home-slide" style="background-image: url('img/background-home-page.jpg');">
            <div class="container">
                <div class="row d-flex justify-content-center align-items-center">
                    <div class="col-auto">
                        <div class="featured-hero-content main-text text-white">
                            <div class="hero-img">
                                <a href="#"><img src="img/icon-pg-white.svg" alt=""></a>
                            </div>
                            <div class="hero-divider"></div>
                            <div class="hero-text text-white">
                                <p>Tradição que inova.</p>
                                <p>Excelência que transforma.</p>
